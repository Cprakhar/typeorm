...
const getExpectedIsolationForDefaultSettings = (isolationLevel: string) => {
    return isolationLevel === "READ UNCOMMITTED"
        ? "READ COMMITTED"
        : isolationLevel
}
